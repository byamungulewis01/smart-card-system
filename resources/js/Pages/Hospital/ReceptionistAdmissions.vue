                        ...
                        <div class="box-body !p-0">
                            <div class="table-responsive">
                                ...
                                <table class="table table-hover whitespace-nowrap min-w-full">
                                    ...
                                    <tbody>
                                        <tr v-for="(admission, index) in admissions.data" :key="index" class="border-t hover:bg-gray-200 dark:hover:bg-light">
                                            ...
                                            <td>
                                                <strong>Blood Pressure :</strong> {{ admission.signs.blood_pressure }} ,  <strong>Temperature :</strong> {{ admission.signs.temperature }} ,  <strong>Respiration :</strong> {{ admission.signs.respiration }}
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
