                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <!-- Navigation Links -->
                            <div v-if="$page.props.auth.user.role == 'Administrator'"
                            ...
                            <div v-else-if="$page.props.auth.user.role == 'Mituelle_officer'"
                                class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink :href="route('dashboard')" :active="route().current('dashboard')">
                                    Dashboard
                                </NavLink>
                            ...
                            <div v-else-if="$page.props.auth.user.role == 'Recieptionist'"
                                class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink :href="route('dashboard')" :active="route().current('dashboard')">
                                    Dashboard
                                </NavLink>
                                ...
                                <NavLink :href="route('admission.receptionist_admissions')" :active="route().current('admission.receptionist_admissions')">
                                    Admissions
                                </NavLink>
                            </div>
                            <div v-else-if="$page.props.auth.user.role == 'Nurse'"
                                class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink :href="route('dashboard')" :active="route().current('dashboard')">
                                    Dashboard
                                </NavLink>
                                ...
                                <NavLink :href="route('admission.nurse_admissions')" :active="route().current('admission.nurse_admissions')">
                                    Admissions
                                </NavLink>
                            </div>
                            <div v-else-if="$page.props.auth.user.role == 'Cashier'"
                                class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink :href="route('dashboard')" :active="route().current('dashboard')">
                                    Dashboard
                                </NavLink>
                                ...
                                <NavLink :href="route('admission.cashier_admissions')" :active="route().current('admission.cashier_admissions')">
                                    Admissions
                                </NavLink>
                            </div>
                            <div v-else-if="$page.props.auth.user.role == 'Pharmacist'"
                                class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink :href="route('dashboard')" :active="route().current('dashboard')">
                                    Dashboard
                                </NavLink>
